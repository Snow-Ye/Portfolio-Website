  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        . I am also familiar with Python, Javascript, and TypeScript. I am
      ...
      <p>
        ...
        video games, snowbarding, and playing with my dog. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning about{" "}
        <span className="font-medium">Japanese and philosophy</span>. I'm also
